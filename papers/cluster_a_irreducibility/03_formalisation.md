...
counter-models. We discuss this further in §8.
...
unified class. The engineering cost — visible as multi-instance
qualifications in cross-structure proofs — admits a philosophical
reading we record only briefly here: the typeclass-mechanism
separation Lean enforces resembles the treatment of attribute as
a "basic and irreducible way of being" that Bennett 1984 §16
develops (cf. p. 61, on attributes as logically irreducible to
one another), while a unified PSR-driven structure (Della Rocca
2008) would require typeclass machinery Lean does not provide.
Whether this engineering–interpretive correlation generalises
beyond Spinoza is the subject of a companion methodology paper
in preparation.
