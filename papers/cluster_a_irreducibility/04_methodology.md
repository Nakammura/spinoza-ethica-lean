...
metamathematical assumptions, Lean 4's underlying Calculus of
Inductive Constructions is consistent under ZFC plus an
inaccessible cardinal (Werner 1997), the same metamathematical
basis used throughout dependent-type-theoretic mathematics. The
assumption is uncontroversial within the proof-assistant
community.
